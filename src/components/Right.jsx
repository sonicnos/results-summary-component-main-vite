...
const Right = ({ reaction, memory, verbal, visual, className }) => {
  return (
    <div className={className}>
      ...
      <div className="flex flex-col gap-5 h-[21rem] pt-12 w-[250px] pb-12">
      ...
      <Button className="bg-[#303b59] cursor-pointer text-white font-semibold flex justify-center items-center w-[17.5rem] h-14 rounded-4xl transition duration-600 ease-in-out hover:bg-gradient-to-b from-[#6641ff] to-[#382ded]">
        Continue
      </Button>
    </div>
  );
